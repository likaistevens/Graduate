...
class Star extends JPanel{
    ...
    public void paintComponent(Graphics g0) {
        ...
        for (int i = 0; i < ss.size(); i++) {
            ...
            ImageIcon icon2 = new ImageIcon("src/star.jpg");
            g2.drawImage(icon2.getImage(), ss.get(i).x, ss.get(i).y, ss.get(i).size, ss.get(i).size, null);
        }
        Graphics2D g = (Graphics2D) (g0);
        ImageIcon icon = new ImageIcon("src/sun.jpg");
        g.drawImage(icon.getImage(),725-50, 400-50,100,100, null);
       
        for (int i = 0; i < s.length; i++) {
            g = (Graphics2D) (g0);
            ImageIcon[] star = {new ImageIcon("src/Mercury.jpg") , new ImageIcon("src/venus.jpg")
                               ,new ImageIcon("src/earth.jpg")   , new ImageIcon("src/mars.jpg")  
                               ,new ImageIcon("src/jupiter.jpg") , new ImageIcon("src/saturn.jpg")
                               ,new ImageIcon("src/uranus.jpg")  , new ImageIcon("src/neptune.jpg")};
